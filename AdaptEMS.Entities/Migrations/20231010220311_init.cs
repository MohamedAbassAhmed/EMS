    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EMSLogs", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedLeaveDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeaveOrders_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveOrders_EmployeeId",
                table: "LeaveOrders",
                column: "EmployeeId");
        }
